            ...
            <div class="card-body">
              <form role="form" action="/create/user" method="POST">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" placeholder="Nama User" aria-label="Name" name="nama_user" required>
                </div>
                <div class="mb-3">
                  <label>No. Telp</label>
                  <input type="text" class="form-control" placeholder="08XXXXXXXXXX" aria-label="08XXXXXXXXXX" name="no_telp" required>
                </div>
                <div class="mb-3">
                  <label>Email</label>
                ...
                <div class="mb-3">
                  ...
                  <input type="date" class="form-control" placeholder="tgl_lahir"name="tgl_lahir" required>
                </div>
                <div class="mb-3">
                  <label>Alamat</label>
